"""Fixed Docker invocation descriptor for AST-SAST."""
...
from orchestrator.infrastructure.scanners.ast_sast_adapter import _MOUNT_PATH, _SAST_ARGV
...
class AstSastInvocation:
    """Fixed argv-only AST-SAST invocation over an owned named volume."""
    ...
    @classmethod
    def from_settings(cls, settings: Settings) -> AstSastInvocation:
        return cls(
            image=settings.scan_sast_image,
            command=_SAST_ARGV,
